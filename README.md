<h1 align="center" style="font-size: 72px; font-weight: 800;">
  TRUPAL PATEL
</h1>

<p align="center">
  Full-Stack Software Engineer • SaaS • AI • Real-Time Systems
</p>

<p align="center">
  Building scalable products, data-heavy systems, and AI-powered workflows
</p>
...
I build production-grade systems focused on scalability, performance, and real-world usability.
...
- Secure RBAC and permission systems  
- End-to-end product engineering (frontend + backend)  
...
### Backend
<p>
  <img src="https://skillicons.dev/icons?i=nodejs,express,python,django,graphql" />
</p>
...
### RetailSync
Multi-tenant retail SaaS platform with accounting workflows and POS ingestion.

- Tenant-aware architecture  
- OAuth + JWT authentication  
- Inventory ledger system  
- Async workflows + QuickBooks integration  

---

### Web-Warehouse
3D warehouse management system with real-time inventory tracking.

- 3D visualization of storage  
- RBAC-based workflows  
...
### Card-Snap OCR
Mobile-first OCR system for business card digitization.

- Image-to-structured data extraction  
- Contact cleanup pipeline  
- MongoDB storage  

---

### Shipping Assistant
AI-powered logistics and procurement tool.
